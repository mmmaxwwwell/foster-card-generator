...
exports.DogProfile = void 0;
class DogProfile {
    constructor(id, name, age, breed, adoptionUrl, gender, size, shots, housetrained, okWithKids, okWithDogs, okWithCats, specialNeeds) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.breed = breed;
